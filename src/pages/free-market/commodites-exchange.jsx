  ...
  return (
    <Box sx={{ position: "relative" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Participate in a Commodities Exchange, where you can trade and
              speculate on valuable resources, influencing the economy and
              potentially making lucrative profits.
            </Box>
          </Box>
        </Box>
      </Box>
      <img
        ...
        width={"100%"}
        alt=""
        src="/img/MarketBackGround3.png"
      />
    </Box>
  );
};

export default CommoditesExchange;
