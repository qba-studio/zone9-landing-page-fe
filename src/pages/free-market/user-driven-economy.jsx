  ...
  return (
    <Box sx={{ position: "relative" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Engage in a user-driven economy where players dictate the prices,
              supply, and demand of goods and services, creating a dynamic and
              evolving market.
            </Box>
          </Box>
        </Box>
      ...
      <img
        ...
        width={"100%"}
        alt=""
        src="/img/MarketBackGround1.png"
      />
    </Box>
  );
};

export default UserDrivenEconomy;
