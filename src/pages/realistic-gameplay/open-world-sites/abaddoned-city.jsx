  ...
  return (
    <Box sx={{ position: "relative" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              A meticulously crafted map that transports you to a
              post-apocalyptic urban landscape. Traverse crumbling buildings,
              navigate through eerie alleyways, and scavenge for vital resources
              amidst the remnants of civilization
            </Box>
          </Box>
        </Box>
      </Box>
      <img
        ...
        width={"100%"}
        alt=""
        src="/img/world/abaddon-city.png"
      />
    </Box>
  );
};
