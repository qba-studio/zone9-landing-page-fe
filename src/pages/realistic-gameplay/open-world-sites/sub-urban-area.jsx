  ...
  return (
    <Box sx={{ position: "relative" }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Immerse yourself in the sprawling Sub-Urban Area, a dynamic and
              densely populated region teeming with opportunities and dangers.
              Navigate through residential neighborhoods, dilapidated buildings,
              and dark alleyways as you encounter rival factions, undertake
              quests, and scavenge for supplies
            </Box>
          </Box>
        </Box>
      </Box>
      <img
        ...
        width={"100%"}
        alt=""
        src="/img/world/sub-urban-area.png"
      />
    </Box>
  );
};
