  ...
  return (
    <Box sx={{ position: "relative" }}>
      ...
      >
        ...
        >
          <Button
            href="/realistic-gameplay/weather-sim/fog"
            sx={{
          ...
          >
            ...
            <GrayLine />
            <Button
              href="/realistic-gameplay/weather-sim/blizzard"
              sx={{
                minWidth: "1px",
                borderRadius: "50%",
                padding: 0,
            ...
            <GrayLine />
            <Button
              href="/realistic-gameplay/weather-sim/sand-storm"
              sx={{
                minWidth: "1px",
                borderRadius: "50%",
                padding: 0,
            ...
            <GrayLine />
            <Button
              href="/realistic-gameplay/weather-sim/sunny"
              sx={{
                minWidth: "1px",
                borderRadius: "50%",
                padding: 0,
      ...
      <img loading="lazy" width={"100%"} alt="" src="/img/weather/rain.png" />
    </Box>
  );
};
