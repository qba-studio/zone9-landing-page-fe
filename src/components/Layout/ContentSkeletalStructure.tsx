...
import MenuButton from "../Icon/MenuButton";

const ContentSkeletalStructure = () => {
          ...
          >
            <Box sx={{ display: "flex", gap: "10px" }}>
              ...
              <Box sx={{ width: "20%", position: "relative" }}>
                ...
                >
                  <img alt="" src="/img/PageSkeletalStructureLogo.png" />
                </Box>
              </Box>
              <Box
                sx={{
...
export default ContentSkeletalStructure;
